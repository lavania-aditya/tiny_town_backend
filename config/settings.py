...
if CLOUD_RUN_SERVICE_URL:
    ...
    ALLOWED_HOSTS.append(urlparse(CLOUD_RUN_SERVICE_URL).hostname)
...
# Cloudinary (used when credentials are set; falls back to local media storage)
_cloud_name = os.environ.get('CLOUDINARY_CLOUD_NAME', '')
if _cloud_name and _cloud_name != 'your-cloud-name':
    CLOUDINARY_STORAGE = {
